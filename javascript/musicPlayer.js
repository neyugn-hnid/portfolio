...
const tracks = [
    {
        id: '1',
        title: 'Angel Speed Up',
        artist: 'Shipu Artist',
        src: 'assets/music/angel.mp3',
        cover: 'https://i.pinimg.com/236x/a3/bf/98/a3bf98e6869c90b2fe8b87cd5f166364.jpg'
    },
    {       
        id: '2',
        title: 'SO TIRED ROCK',
        artist: 'NUEKI PHONK',
        src: 'assets/music/SO_TIRED_ROCK.mp3',
        cover: 'https://i.ytimg.com/vi/GXjZfcwLx5M/maxresdefault.jpg'
    },
    {
        id: '3',
        title: 'Happy Rock',
...
const initializePlayer = () => {
    ...
    audioSource.setAttribute('src', firstTrack.src);
    audioSource.dataset.trackid = firstTrack.id;
    songTitle.innerHTML = firstTrack.title;
    songArtist.innerHTML = firstTrack.artist;
    spinnerDisc.style.backgroundImage = `url(${firstTrack.cover})`;
    
    // Load the audio and auto-play
    audio.load();
    audio.addEventListener('canplay', () => {
        audio.play();
        playing = true;
